...
import 'graphql/github.data.gql.dart';
import 'graphql/github.req.gql.dart';

class MainPage extends StatefulWidget {
  MainPage({required http.Client client})
      : _link = HttpLink(
...
class _RepositoriesListState extends State<RepositoriesList> {
  ...
  Future<List<GRepositoriesData_viewer_repositories_nodes>> _retreiveRespositories(Link link) async {
