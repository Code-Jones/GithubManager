...
abstract class GGetGistsVars
    implements Built<GGetGistsVars, GGetGistsVarsBuilder> {
  GGetGistsVars._();

  factory GGetGistsVars([Function(GGetGistsVarsBuilder b) updates]) =
      _$GGetGistsVars;

  int get count;
  static Serializer<GGetGistsVars> get serializer => _$gGetGistsVarsSerializer;
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GGetGistsVars.serializer, this)
          as Map<String, dynamic>);
  static GGetGistsVars? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GGetGistsVars.serializer, json);
}
