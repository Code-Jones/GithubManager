...
import 'package:githubmanager/graphql/github-schema.schema.gql.dart' as _i2;
import 'package:githubmanager/graphql/serializers.gql.dart' as _i1;
...
abstract class GGetGistsData
    implements Built<GGetGistsData, GGetGistsDataBuilder> {
  GGetGistsData._();

  factory GGetGistsData([Function(GGetGistsDataBuilder b) updates]) =
      _$GGetGistsData;

  static void _initializeBuilder(GGetGistsDataBuilder b) =>
      b..G__typename = 'Query';
  @BuiltValueField(wireName: '__typename')
  String get G__typename;
  GGetGistsData_viewer get viewer;
  static Serializer<GGetGistsData> get serializer => _$gGetGistsDataSerializer;
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GGetGistsData.serializer, this)
          as Map<String, dynamic>);
  static GGetGistsData? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GGetGistsData.serializer, json);
}

abstract class GGetGistsData_viewer
    implements Built<GGetGistsData_viewer, GGetGistsData_viewerBuilder> {
  GGetGistsData_viewer._();

  factory GGetGistsData_viewer(
          [Function(GGetGistsData_viewerBuilder b) updates]) =
      _$GGetGistsData_viewer;

  static void _initializeBuilder(GGetGistsData_viewerBuilder b) =>
      b..G__typename = 'User';
  @BuiltValueField(wireName: '__typename')
  String get G__typename;
  GGetGistsData_viewer_gists get gists;
  static Serializer<GGetGistsData_viewer> get serializer =>
      _$gGetGistsDataViewerSerializer;
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GGetGistsData_viewer.serializer, this)
          as Map<String, dynamic>);
  static GGetGistsData_viewer? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GGetGistsData_viewer.serializer, json);
}

abstract class GGetGistsData_viewer_gists
    implements
        Built<GGetGistsData_viewer_gists, GGetGistsData_viewer_gistsBuilder> {
  GGetGistsData_viewer_gists._();

  factory GGetGistsData_viewer_gists(
          [Function(GGetGistsData_viewer_gistsBuilder b) updates]) =
      _$GGetGistsData_viewer_gists;

  static void _initializeBuilder(GGetGistsData_viewer_gistsBuilder b) =>
      b..G__typename = 'GistConnection';
  @BuiltValueField(wireName: '__typename')
  String get G__typename;
  BuiltList<GGetGistsData_viewer_gists_nodes>? get nodes;
  static Serializer<GGetGistsData_viewer_gists> get serializer =>
      _$gGetGistsDataViewerGistsSerializer;
  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
      GGetGistsData_viewer_gists.serializer, this) as Map<String, dynamic>);
  static GGetGistsData_viewer_gists? fromJson(Map<String, dynamic> json) =>
      _i1.serializers
          .deserializeWith(GGetGistsData_viewer_gists.serializer, json);
}

abstract class GGetGistsData_viewer_gists_nodes
    implements
        Built<GGetGistsData_viewer_gists_nodes,
            GGetGistsData_viewer_gists_nodesBuilder> {
  GGetGistsData_viewer_gists_nodes._();

  factory GGetGistsData_viewer_gists_nodes(
          [Function(GGetGistsData_viewer_gists_nodesBuilder b) updates]) =
      _$GGetGistsData_viewer_gists_nodes;

  static void _initializeBuilder(GGetGistsData_viewer_gists_nodesBuilder b) =>
      b..G__typename = 'Gist';
  @BuiltValueField(wireName: '__typename')
  String get G__typename;
  BuiltList<GGetGistsData_viewer_gists_nodes_files>? get files;
  _i2.GURI get url;
  static Serializer<GGetGistsData_viewer_gists_nodes> get serializer =>
      _$gGetGistsDataViewerGistsNodesSerializer;
  Map<String, dynamic> toJson() => (_i1.serializers
          .serializeWith(GGetGistsData_viewer_gists_nodes.serializer, this)
      as Map<String, dynamic>);
  static GGetGistsData_viewer_gists_nodes? fromJson(
          Map<String, dynamic> json) =>
      _i1.serializers
          .deserializeWith(GGetGistsData_viewer_gists_nodes.serializer, json);
}

abstract class GGetGistsData_viewer_gists_nodes_files
    implements
        Built<GGetGistsData_viewer_gists_nodes_files,
            GGetGistsData_viewer_gists_nodes_filesBuilder> {
  GGetGistsData_viewer_gists_nodes_files._();

  factory GGetGistsData_viewer_gists_nodes_files(
          [Function(GGetGistsData_viewer_gists_nodes_filesBuilder b) updates]) =
      _$GGetGistsData_viewer_gists_nodes_files;

  static void _initializeBuilder(
          GGetGistsData_viewer_gists_nodes_filesBuilder b) =>
  ...
  int? get size;
  String? get text;
  static Serializer<GGetGistsData_viewer_gists_nodes_files> get serializer =>
      _$gGetGistsDataViewerGistsNodesFilesSerializer;
  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
          GGetGistsData_viewer_gists_nodes_files.serializer, this)
      as Map<String, dynamic>);
  static GGetGistsData_viewer_gists_nodes_files? fromJson(
          Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(
          GGetGistsData_viewer_gists_nodes_files.serializer, json);
}
