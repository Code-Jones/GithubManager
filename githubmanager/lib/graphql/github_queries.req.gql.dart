...
import 'package:githubmanager/graphql/github_queries.ast.gql.dart' as _i2;
import 'package:githubmanager/graphql/github_queries.var.gql.dart' as _i3;
import 'package:githubmanager/graphql/serializers.gql.dart' as _i4;
...
abstract class GGetGists implements Built<GGetGists, GGetGistsBuilder> {
  GGetGists._();

  factory GGetGists([Function(GGetGistsBuilder b) updates]) = _$GGetGists;

  static void _initializeBuilder(GGetGistsBuilder b) => b
    ..operation =
        _i1.Operation(document: _i2.document, operationName: 'GetGists');
  _i3.GGetGistsVars get vars;
  _i1.Operation get operation;
  static Serializer<GGetGists> get serializer => _$gGetGistsSerializer;
  Map<String, dynamic> toJson() =>
      (_i4.serializers.serializeWith(GGetGists.serializer, this)
          as Map<String, dynamic>);
  static GGetGists? fromJson(Map<String, dynamic> json) =>
      _i4.serializers.deserializeWith(GGetGists.serializer, json);
}
