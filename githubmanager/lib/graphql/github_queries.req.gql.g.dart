...
Serializer<GGetGists> _$gGetGistsSerializer = new _$GGetGistsSerializer();
...
class _$GGetGistsSerializer implements StructuredSerializer<GGetGists> {
  @override
  final Iterable<Type> types = const [GGetGists, _$GGetGists];
  @override
  final String wireName = 'GGetGists';

  @override
  Iterable<Object?> serialize(Serializers serializers, GGetGists object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GGetGistsVars)),
      'operation',
      serializers.serialize(object.operation,
          specifiedType: const FullType(_i1.Operation)),
    ];
  ...
  @override
  GGetGists deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GGetGistsBuilder();
...
class _$GGetGists extends GGetGists {
  @override
  final _i3.GGetGistsVars vars;
  @override
  final _i1.Operation operation;

  factory _$GGetGists([void Function(GGetGistsBuilder)? updates]) =>
      (new GGetGistsBuilder()..update(updates)).build();

  _$GGetGists._({required this.vars, required this.operation}) : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, 'GGetGists', 'vars');
    BuiltValueNullFieldError.checkNotNull(operation, 'GGetGists', 'operation');
  }

  @override
  GGetGists rebuild(void Function(GGetGistsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GGetGistsBuilder toBuilder() => new GGetGistsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GGetGists &&
        vars == other.vars &&
        operation == other.operation;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GGetGists')
          ..add('vars', vars)
          ..add('operation', operation))
        .toString();
  }
...
class GGetGistsBuilder implements Builder<GGetGists, GGetGistsBuilder> {
  _$GGetGists? _$v;

  _i3.GGetGistsVarsBuilder? _vars;
  _i3.GGetGistsVarsBuilder get vars =>
      _$this._vars ??= new _i3.GGetGistsVarsBuilder();
  set vars(_i3.GGetGistsVarsBuilder? vars) => _$this._vars = vars;
  ...
  GGetGistsBuilder() {
    GGetGists._initializeBuilder(this);
  }

  GGetGistsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _vars = $v.vars.toBuilder();
      _operation = $v.operation;
  ...
  @override
  void replace(GGetGists other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GGetGists;
  }

  @override
  void update(void Function(GGetGistsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$GGetGists build() {
    _$GGetGists _$result;
    try {
      _$result = _$v ??
          new _$GGetGists._(
              vars: vars.build(),
              operation: BuiltValueNullFieldError.checkNotNull(
                  operation, 'GGetGists', 'operation'));
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'vars';
        ...
        throw new BuiltValueNestedFieldError(
            'GGetGists', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
