...
Serializer<GGetGistsVars> _$gGetGistsVarsSerializer =
    new _$GGetGistsVarsSerializer();
...
class _$GGetGistsVarsSerializer implements StructuredSerializer<GGetGistsVars> {
  @override
  final Iterable<Type> types = const [GGetGistsVars, _$GGetGistsVars];
  @override
  final String wireName = 'GGetGistsVars';

  @override
  Iterable<Object?> serialize(Serializers serializers, GGetGistsVars object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'count',
  ...
  @override
  GGetGistsVars deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GGetGistsVarsBuilder();
...
class _$GGetGistsVars extends GGetGistsVars {
  @override
  final int count;

  factory _$GGetGistsVars([void Function(GGetGistsVarsBuilder)? updates]) =>
      (new GGetGistsVarsBuilder()..update(updates)).build();

  _$GGetGistsVars._({required this.count}) : super._() {
    BuiltValueNullFieldError.checkNotNull(count, 'GGetGistsVars', 'count');
  }

  @override
  GGetGistsVars rebuild(void Function(GGetGistsVarsBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GGetGistsVarsBuilder toBuilder() => new GGetGistsVarsBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GGetGistsVars && count == other.count;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GGetGistsVars')..add('count', count))
        .toString();
  }
}

class GGetGistsVarsBuilder
    implements Builder<GGetGistsVars, GGetGistsVarsBuilder> {
  _$GGetGistsVars? _$v;
  ...
  GGetGistsVarsBuilder();

  GGetGistsVarsBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _count = $v.count;
      _$v = null;
  ...
  @override
  void replace(GGetGistsVars other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GGetGistsVars;
  }

  @override
  void update(void Function(GGetGistsVarsBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$GGetGistsVars build() {
    final _$result = _$v ??
        new _$GGetGistsVars._(
            count: BuiltValueNullFieldError.checkNotNull(
                count, 'GGetGistsVars', 'count'));
    replace(_$result);
    return _$result;
  }
}
